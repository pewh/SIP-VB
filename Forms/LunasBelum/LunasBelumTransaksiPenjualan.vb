Public Class LunasBelumTransaksiPenjualan
    ...
    Private Sub filtering()
        ...
        If txtCari.Text <> "" Or
            ...
            fetchToDatagrid(datagrid, "SELECT tanggal, kode, lunas FROM FakturJual WHERE " + criteria + " ORDER BY tanggal DESC")
        Else
            fetchToDatagrid(datagrid, "SELECT tanggal, kode, lunas FROM FakturJual ORDER BY tanggal DESC")
        End If
    ...
    Private Sub LunasBelumTransaksiPenjualan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub datagrid_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles datagrid.CellValueChanged
        ...
        Dim query As String = String.Format("UPDATE FakturJual SET lunas = {0} WHERE kode = '{1}'", statusLunas, kodeFaktur)
