Public Class Home
    ...
    Private Sub menuLunasBelumTransaksiPembelian_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuLunasBelumTransaksiPembelian.Click
        ...
        'frm.MdiParent = Me
        LunasBelumTransaksiPembelian.Show()
    End Sub
    ...
    Private Sub menuLunasBelumTransaksiPenjualan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuLunasBelumTransaksiPenjualan.Click
        ...
        'frm.MdiParent = Me
        LunasBelumTransaksiPenjualan.Show()
    End Sub
    ...
    Private Sub menuPengeluaranOperasional_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuPengeluaranOperasional.Click
        PengeluaranOperasional.Show()
    End Sub
End Class